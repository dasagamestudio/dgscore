...
internal sealed class ScriptKeywordProcessor : UnityEditor.AssetModificationProcessor {
    ...
    public static void OnWillCreateAsset(string path) {
        ...
        file = file.Replace("#CREATIONDATE#", "Created On: " + System.DateTime.Now + "");
        file = file.Replace("#MODIFICATIONDATE#", "Modified On: " + System.DateTime.Now + "");
        file = file.Replace("#PROJECTNAME#", "Project Name: " + PlayerSettings.productName);
        file = file.Replace("#DEVELOPERNAME#", "Developer Name: " + "Ankit Sethi - ankitsethi@dasagamestudio.com");
        file = file.Replace("#COMPANY#", "Company: " + PlayerSettings.companyName);
        file = file.Replace("#COPYRIGHT#", "Copyright: " + "@ Copyright 2019-2020. All rights Reserved. " + PlayerSettings.companyName);
